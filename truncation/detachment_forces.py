...
background = ax.pcolormesh(X, Y, detachment_forces.T, vmin=0, shading='auto', cmap=parula_map)
cbar = plt.colorbar(background, ax=ax, location='top', fraction=0.05, aspect=11, pad=0.03, ticks=[0, 2, 4, 6])

cbar.ax.text(1.1, 0.3, r'$f_\mathrm{detach}$', fontsize=12, transform=cbar.ax.transAxes)

cbar.outline.set_linewidth(0)
cbar.ax.tick_params(axis='both', which='major', direction='in', labelsize=10, pad=0)
